...
with st.form("form_contenido"):
    ...
    with col1:
        ...
        tono = st.select_slider(
            "Tono", options=["Formal", "Cercano", "Divertido / picante"], value="Cercano"
        )
    with col2:
...
2. Una línea aparte con 15 hashtags relevantes para eventos, DJs y salones de fiestas en
   La Plata / Villa Elisa, Buenos Aires, Argentina (mezclá hashtags genéricos y locales)
...
No inventes datos de contacto ni precios.
"""
